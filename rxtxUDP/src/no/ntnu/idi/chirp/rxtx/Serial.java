...
public class Serial implements SerialPortEventListener {
  ...
  public Serial(int baudRate) throws SerialPortException {
    this("COM1", baudRate, 'N', 8, 1);
  }

  
  public Serial(String portName) throws SerialPortException {
    this(portName, 9600, 'N', 8, 1);
  }

  
  public Serial( String portName, int baudRate) throws SerialPortException {
    this( portName, baudRate, 'N', 8, 1);
  }

  
  public Serial(String portName, int baudRate, char parity, int dataBits, float stopBits) throws SerialPortException {
  ...
  public void pre() {
    if (serialAvailableMethod != null && invokeSerialAvailable) {
      ...
      try {
        serialAvailableMethod.invoke(this);
      } catch (Exception e) {
  ...
  public void stop() {
    try {
      ...
      // ignored
    	System.err.println("Serial port exception: " + e.getMessage());
    }
    inBuffer = 0;
    readOffset = 0;
  }
